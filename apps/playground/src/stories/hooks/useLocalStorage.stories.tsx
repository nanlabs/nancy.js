...
export const Example: FC = () => {
  ...
  const [valueThree, setValueThree] = useLocalStorage("key-three", INITIAL_VALUE_THREE);
  ...
  return (
    <div>
      ...
      <SimpleRowExample>
        <button onClick={() => setValueOne && setValueOne('new value')}>change value one</button>
        <button onClick={() => setValueTwo && setValueTwo((prev) => prev + 1)}>
          change value two
        </button>
        <button onClick={() => setValueThree && setValueThree((prev) => ({
          ...prev,
          name: "Older John",
          age: prev.age + 1,
        }))}>
      ...
      <SimpleRowExample>
      <button onClick={() => setValueOne && setValueOne(INITIAL_VALUE_ONE)}>reset value one</button>
        <button onClick={() => setValueTwo && setValueTwo(INITIAL_VALUE_TWO)}>
          reset value two
        </button>
        <button onClick={() => setValueThree && setValueThree(INITIAL_VALUE_THREE)}>reset value three</button>
      </SimpleRowExample>
    </div>
  );
};
